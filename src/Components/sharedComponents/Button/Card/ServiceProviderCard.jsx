...
const ServiceProviderCard = ({service}) => {
    ...
    return (
        <>
      <div
        className='card relative h-36  w-36 hover:rotate-6  rounded-lg bg-base-400 transition-[all_400ms_cubic-bezier(0.03,0.98,0.52,0.99)_0s] will-change-transform'
          
      >
        
        <div className='group relative flex h-full w-full select-none items-center justify-center rounded-lg border
