                    ...
                    <div className="px-6 py-8 text-center">
                        ...
                        <form onSubmit={handleSingIn} >
                            ...
                            <div className="flex items-center justify-between mt-4">
                                ...
                                <input value="Sing In" type="submit" className="px-6 py-2 font-medium text-white transition-colors duration-300 transform bg-gray-900 rounded-md hover:bg-primary dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-800 dark:focus:bg-gray-700"/>
                            </div>
                            <h2 className="my-5">Don't have an account? <Link to='/login'><span className="text-primary">Please signUp</span></Link> </h2>
                        </form>
                        <hr />
                    </div><div onClick={handleGoogleLogin} className="md:text-xl bg-blue-600 w-full  md:w-96 border-none hover:bg-primary flex mb-10 mx-auto btn"><FcGoogle/> <h2>SingUp with Google</h2></div>
                </div>
            </div>
        </div>
    </div>
